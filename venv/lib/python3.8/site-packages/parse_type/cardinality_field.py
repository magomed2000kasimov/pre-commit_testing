...
class CardinalityFieldTypeBuilder(object):
    ...
    def create_type_variant(cls, type_name, type_converter):
        ...
        type_variant = TypeBuilder.with_cardinality(
            cardinality, type_converter, listsep=cls.listsep
        )
    ...
    def create_missing_type_variants(cls, type_names, type_dict):
        ...
        """
        missing_type_names = [name for name in type_names if name not in type_dict]
