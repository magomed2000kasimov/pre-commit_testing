...
class TouchActions(object):
    ...
    def tap(self, on_element):
        ...
        self._actions.append(
            lambda: self._driver.execute(Command.SINGLE_TAP, {"element": on_element.id})
        )
        return self
    ...
    def double_tap(self, on_element):
        ...
        """
        self._actions.append(
            lambda: self._driver.execute(Command.DOUBLE_TAP, {"element": on_element.id})
        )
        return self
    ...
    def scroll(self, xoffset, yoffset):
        ...
        self._actions.append(
            lambda: self._driver.execute(
                Command.TOUCH_SCROLL, {"xoffset": int(xoffset), "yoffset": int(yoffset)}
            )
        )
        return self
    ...
    def long_press(self, on_element):
        ...
        """
        self._actions.append(
            lambda: self._driver.execute(Command.LONG_PRESS, {"element": on_element.id})
        )
        return self
